...
public class MapDBTest {
    ...
    @Test
    public void testMapDb4() {
        DB db = DBMaker.fileDB("test2.db").make();

        ConcurrentMap map2 = db.hashMap("1", Serializer.STRING, Serializer.STRING).createOrOpen();
        //Map<String, String>
    ...
    @Test
    public void testMapDb2() {
        List<Bond> list = new ArrayList<>();
        for (int i = 0; i < 10000; i++) {
            list.addAll(BondAccess.getAllBond());
        }

        System.out.println("bond size:" + list.size());



/*        Map<String, List<Bond>> map1 = new HashMap<>();
        map1.put("javaMap", list);*/
